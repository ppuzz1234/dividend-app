...
export function AllocationPlan({ manualAccounts, income, finIncome = 0, age, taxPref = "growth", isaRollover = "isa1", liquidity = null, perAccount = null, monthlyContribution = 0, years = 20, initialAlloc, onNext }) {
  const { rooms } = useMemo(
    () => buildAccountRooms({ mydata: true, manual: manualAccounts, income, finIncome, age, monthlyContribution, taxPref, isaRollover, liquidity, perAccount }),
    [manualAccounts, income, finIncome, age, monthlyContribution, taxPref, isaRollover, liquidity, perAccount]
  );
