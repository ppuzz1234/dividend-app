...
export function AllocationPlan({ manualAccounts, income, age, taxPref = "growth", isaRollover = "isa1", monthlyContribution = 0, years = 20, initialAlloc, onNext }) {
  const { rooms } = useMemo(
    () => buildAccountRooms({ mydata: true, manual: manualAccounts, income, age, monthlyContribution, taxPref, isaRollover }),
    [manualAccounts, income, age, monthlyContribution, taxPref, isaRollover]
  );
