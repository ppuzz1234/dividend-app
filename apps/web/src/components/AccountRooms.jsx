...
export function AccountRooms({ mydata, manual, income, age, monthlyContribution = 0, taxPref = "growth", isaRollover = "isa1" }) {
  const { rooms, openable } = buildAccountRooms({ mydata, manual, income, age, monthlyContribution, taxPref, isaRollover });
