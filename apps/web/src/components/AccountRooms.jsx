...
export function AccountRooms({ mydata, manual, income, monthlyContribution = 0 }) {
  const { rooms, openable } = buildAccountRooms({ mydata, manual, income, monthlyContribution });
